...
### strsubstring(char *string, int startIndex, int endIndex)

```C
String subString = strsubstring(string, startIndex, endIndex);
```
...
### ssubstring(char *string, int startIndex, int endIndex)

```C
char *subString = ssubstring(string, startIndex, endIndex);
```
